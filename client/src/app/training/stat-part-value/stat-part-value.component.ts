...
import { StatPart, CountStatPart, FractionStatPart, DnfStatPart, DurationStatPart, isCountStatPart, isFractionStatPart, isDnfStatPart, isDurationStatPart } from '../stat-part.model';
