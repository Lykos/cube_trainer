...
require Rails.root.join('db/migrate/20200401075552_add_mode_id_to_inputs.rb')

describe AddModeIdToInputs do
  ...
  let(:previous_version) { 20200401075549 }
  let(:current_version) { 20200401075552 }
