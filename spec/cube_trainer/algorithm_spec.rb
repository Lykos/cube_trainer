...
describe Algorithm do
  ...
  it "should apply a rotation correctly to Sarahs skewb algorithm" do
    expect(parse_sarahs_skewb_algorithm("F U R'").rotate_by(parse_move("y"))).to be == parse_sarahs_skewb_algorithm("L U F'")
    expect(parse_sarahs_skewb_algorithm("L U F'").rotate_by(parse_move("y"))).to be == parse_sarahs_skewb_algorithm("B U L'")
    expect(parse_sarahs_skewb_algorithm("B U L'").rotate_by(parse_move("y"))).to be == parse_sarahs_skewb_algorithm("R U B'")
    expect(parse_sarahs_skewb_algorithm("R U B'").rotate_by(parse_move("y"))).to be == parse_sarahs_skewb_algorithm("F U R'")

    expect(parse_sarahs_skewb_algorithm("F U R'").rotate_by(parse_move("y2"))).to be == parse_sarahs_skewb_algorithm("B U L'")
    expect(parse_sarahs_skewb_algorithm("L U F'").rotate_by(parse_move("y2"))).to be == parse_sarahs_skewb_algorithm("R U B'")
    expect(parse_sarahs_skewb_algorithm("B U L'").rotate_by(parse_move("y2"))).to be == parse_sarahs_skewb_algorithm("F U R'")
    expect(parse_sarahs_skewb_algorithm("R U B'").rotate_by(parse_move("y2"))).to be == parse_sarahs_skewb_algorithm("L U F'")
    
    expect(parse_sarahs_skewb_algorithm("F U R'").rotate_by(parse_move("y'"))).to be == parse_sarahs_skewb_algorithm("R U B'")
    expect(parse_sarahs_skewb_algorithm("L U F'").rotate_by(parse_move("y'"))).to be == parse_sarahs_skewb_algorithm("F U R'")
    expect(parse_sarahs_skewb_algorithm("B U L'").rotate_by(parse_move("y'"))).to be == parse_sarahs_skewb_algorithm("L U F'")
    expect(parse_sarahs_skewb_algorithm("R U B'").rotate_by(parse_move("y'"))).to be == parse_sarahs_skewb_algorithm("B U L'")
  end
