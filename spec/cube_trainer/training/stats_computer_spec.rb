  ...
  let(:results) do
    ...
    other_mode_results =
      other_commutator_infos.map do |_k, v|
        ...
        Training::Result.new(mode, t_2_days_ago, 1.0, letter_pair_b, 0, nil, true, false)
      end
    fill_results = fill_letter_pairs.map { |ls| Training::Result.new(mode, t_2_days_ago, 1.0, ls, 0, nil, true, false) }
    [
      Training::Result.new(mode, t_10_minutes_ago, 1.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_10_minutes_ago, 2.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_10_minutes_ago, 3.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_10_minutes_ago, 4.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_10_minutes_ago, 5.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_10_minutes_ago - 1, 6.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_hours_ago, 7.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_days_ago, 10.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_days_ago, 11.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_days_ago, 12.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_days_ago, 13.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_days_ago, 14.0, letter_pair_a, 0, nil, true, false),
      Training::Result.new(mode, t_2_hours_ago, 10.0, letter_pair_b, 0, nil, true, false)
