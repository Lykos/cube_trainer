...
describe Algorithm do
  ...
  it "should mirror Sarahs skewb algorithms correctly" do
    red_face = Face.for_color(:red)
    expect(parse_sarahs_skewb_algorithm("F U R'").mirror(red_face)).to be == parse_sarahs_skewb_algorithm("L' U B")
    expect(parse_sarahs_skewb_algorithm("L U F'").mirror(red_face)).to be == parse_sarahs_skewb_algorithm("F' U L")
    expect(parse_sarahs_skewb_algorithm("B U L'").mirror(red_face)).to be == parse_sarahs_skewb_algorithm("R' U F")
    expect(parse_sarahs_skewb_algorithm("R U B'").mirror(red_face)).to be == parse_sarahs_skewb_algorithm("B' U R")

    green_face = Face.for_color(:green)
    expect(parse_sarahs_skewb_algorithm("F U R'").mirror(green_face)).to be == parse_sarahs_skewb_algorithm("R' U F")
    expect(parse_sarahs_skewb_algorithm("L U F'").mirror(green_face)).to be == parse_sarahs_skewb_algorithm("B' U R")
    expect(parse_sarahs_skewb_algorithm("B U L'").mirror(green_face)).to be == parse_sarahs_skewb_algorithm("L' U B")
    expect(parse_sarahs_skewb_algorithm("R U B'").mirror(green_face)).to be == parse_sarahs_skewb_algorithm("F' U L")
  end
end
