...
def sheet_filter(args)
  ...
  CubeTrainer::SheetScraping::RegexpSheetFilter.new(owner_regexp: owner_regexp, sheet_title_regexp: sheet_title_regexp)
end

desc 'Scrape algs sheets from Google sheets'
task :scrape_sheets, [:owner_regexp, :sheet_title_regexp] => :environment do |_task, args|
