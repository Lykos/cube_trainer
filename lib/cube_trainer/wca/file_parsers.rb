...
module CubeTrainer
  module WCA
    ...
    module FileParsers
      ...
      FILE_PARSERS = {
        competitions: CSVFileParser.new(
      ...
      SCRAMBLES_FILE_PARSER = CSVFileParser.new(
